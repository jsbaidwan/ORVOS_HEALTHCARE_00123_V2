...
export const PreviewImage = ({ preview, index, eyeType, removePreview, eyeColor, hasRemoveButton = true, fullSize = false, hasCustomClass = "", hasViewButton = true }) => {
  ...
  const heightClass = fullSize ? "h-40 object-cover" : hasCustomClass ? hasCustomClass : "h-40 object-cover";
  ...
  return (
    <>
      <div className={`relative group overflow-hidden rounded-lg border-${eyeColor ? 2 : 1} border-${eyeColor}-200`}>
        ...
        {fileloading ? (
          <PhotoIcon className={`w-full ${fullSize ? 'h-40' : hasCustomClass ? hasCustomClass : 'h-40'} border border-gray-200 rounded p-1 object-cover bg-gray-100 animate-pulse`} />
        ) : (
          <>
            {!blobUrl ? (
              <PhotoIcon className={`w-full ${fullSize ? 'h-40' : hasCustomClass ? hasCustomClass : 'h-40'} border border-gray-200 rounded p-1 object-cover bg-gray-100 animate-pulse`} />
