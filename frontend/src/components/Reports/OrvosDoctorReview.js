...
const OrvosDoctorReview = () => {
  ...
  useEffect(() => {
    setPageTitle('Orvos Doctor Review');
  }, [setPageTitle]);
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      try {
        const response = await getDoctorReviewReport(1, filters, false);
  ...
  /* ── data from API ──────────────────────── */
  const orvosDoctorReviews = reports?.orvosDoctorReviews || {};
  ...
  const hasData = Object.keys(orvosDoctorReviews).length > 0;
    ...
    <div className="py-6">
      ...
      <div className="mb-3">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-semibold text-gray-900">Orvos Doctor Review</h1>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-6">
        ...
        {hasData && (
          <div className="mt-3 flex justify-end">
            <button
              onClick={() => exportExcel('orvos-doctor-review')}
      ...
      {isDataLoaded ? (
              ...
              <div className="p-6">
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full border border-gray-200 text-sm">
                    ...
                    <tbody>
                      {Object.entries(orvosDoctorReviews).map(([clinic, doctors], clinicIdx) => {
                        ...
                        return (
                          <React.Fragment key={clinic}>
                            ...
                            {/* spacer */}
                            {clinicIdx < Object.keys(orvosDoctorReviews).length - 1 && (
                              <tr>
                                <td
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm mb-6 animate-pulse opacity-70">
          ...
          <PageLoader loading={true} title="Orvos Doctor Review Report..." />
        </div>
      )}
    </div>
  );
