              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {showDropdown && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 border border-gray-200 z-50">
                    ...
                    <Link to={getRoutePath('/profile')}
                      className="block px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 transition-colors duration-200"
                      onClick={() => setShowDropdown(false)}>

                      <div className="flex items-center space-x-2">
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5h2m-6 14h10a2 2 0 002-2V9l-4-4H7a2 2 0 00-2 2v10a2 2 0 002 2z" />
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.5 11.5l2 2L10 20H8v-2l6.5-6.5z" />
                        </svg>
                        <span>Profile</span>
                      </div>
