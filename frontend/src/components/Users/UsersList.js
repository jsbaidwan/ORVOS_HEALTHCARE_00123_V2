    ...
    },
    {
      ...
      render: (row) => (
        <div className="flex items-center space-x-2">
          <Link to={getRoutePath(`/users/${row.id}/edit`)} className="p-2 text-primary hover:bg-primary-200 rounded-lg transition-colors duration-200" title="View">
    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 space-y-4 sm:space-y-0">
        ...
        <div className="flex space-x-3">
            <Link to={getRoutePath('/users/create')} className="inline-flex items-center justify-center px-4 py-2 w-full sm:w-auto border border-transparent rounded-md shadow-sm text-sm sm:text-base font-medium text-white bg-[#009efb] hover:bg-[#0089db] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#009efb]">
