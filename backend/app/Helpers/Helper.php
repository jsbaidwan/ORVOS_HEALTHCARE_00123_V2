...
class Helper{
	...
	*/
	...
	{
		return [
			['id' => 1,'name' => '6-Mths','class' => 'bg-warning','color' => '#ffc107'],
			['id' => 2,'name' => '12-Mths','class' => 'bg-secondary','color' => '#6c757d'],
			['id' => 3,'name' => 'Urgent','class' => 'bg-danger','color' => '#dc3545'],
			['id' => 4,'name' => 'Schedule Dr Visit','class' => 'bg-success','color' => '#198754']
		];
	}
...
<p style="text-align: right;"><img src="'.$footerLogo.'"  style="width: 224px;" class="fr-fic fr-dib fr-fir"></p>
	...
	*/
	...
	/*
	|--------------------------------------------------------------------------
	| Start: Get Screening Types
	|--------------------------------------------------------------------------
	*/
	
	public static function screeningTypes()
	{
		return [
			[
				'id' => 1,
	...
	/*
	|--------------------------------------------------------------------------
	| End: Get Screening Types
	|--------------------------------------------------------------------------
	*/
	
	/*
	|--------------------------------------------------------------------------
	| Start: Get Screening Type By Id
	|--------------------------------------------------------------------------
	*/
	
	public static function screeningTypeById($id)
	{
		$screeningTypes = self::screeningTypes();
		foreach($screeningTypes as $val){
			if($val['id'] == $id){
				return ['status' => 200,'screeningType' => $val];
			}
		}
	...
	/*
	|--------------------------------------------------------------------------
	| End: Get Screening Type By Id
	|--------------------------------------------------------------------------
	*/
	
	/*
	|--------------------------------------------------------------------------
	| Start: Get Thyroid Eye Disease
	|--------------------------------------------------------------------------
	*/
	
	public static function tedDisease()
	{
		return [
			[
				'id' => 1,
	...
	/*
	|--------------------------------------------------------------------------
	| End: Get Thyroid Eye Disease
	|--------------------------------------------------------------------------
	*/
	
	/*
	|--------------------------------------------------------------------------
	| Start: Get Thyroid Eye Disease By Id
	|--------------------------------------------------------------------------
	*/
	
	public static function tedDiseaseById($id)
	{
		$tedDisease = self::tedDisease();
		foreach($tedDisease as $val){
			if($val['id'] == $id){
				return ['status' => 200,'tedDisease' => $val];
			}
		}
