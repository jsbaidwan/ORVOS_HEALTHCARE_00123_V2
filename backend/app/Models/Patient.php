...
class Patient extends Authenticatable
{
     ...
     */
	protected $fillable = [
		'slug','study_id','p_code','user_id','provider_id', 'dob', 'gender', 'phone', 'clinic_id', 'mr_number', 'address', 'city', 'state_id', 'zip', 
	...
	public static $rules = array(
		...
		//'provider_id' => 'required|string|max:255|unique:patients',
		//'dob' => 'required',
